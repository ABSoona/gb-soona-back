...
@InputType()
class DemandeSituationHistoryUpdateInput {
  @ApiProperty({
    required: false,
  ...
  creePar?: UserWhereUniqueInput | null;
...
export { DemandeSituationHistoryUpdateInput as DemandeSituationHistoryUpdateInput };
