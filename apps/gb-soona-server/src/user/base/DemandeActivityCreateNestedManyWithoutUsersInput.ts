...
@InputType()
class DemandeActivityCreateNestedManyWithoutUsersInput {
...
export { DemandeActivityCreateNestedManyWithoutUsersInput as DemandeActivityCreateNestedManyWithoutUsersInput };
